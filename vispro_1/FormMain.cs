...
namespace vispro_1
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            alamat = "server=localhost; database=vispro_1; username=root; password=;";
        ...
        private void FormMain_Load(object sender, EventArgs e)
        {
            ...
            {
                koneksi.Open();
                query = string.Format("select * from tab_pengguna");
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtUsername.Text != "" && txtPassword.Text != "" && txtName.Text != "")
                {
                    ...
                    query = string.Format("insert into tab_pengguna  values ('{0}','{1}','{2}','{3}','{4}');", txtID.Text, txtUsername.Text, txtPassword.Text, txtName.Text, cbLevel.Text);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtPassword.Text != "" && txtName.Text != "" && txtUsername.Text != "" && txtID.Text != "")
                {
                    ...
                    query = string.Format("update tab_pengguna set password = '{0}', nama_pengguna = '{1}', level = '{2}' where id_pengguna = '{3}'", txtPassword.Text, txtName.Text, cbLevel.Text, txtID.Text);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtUsername.Text != "")
                {
                    query = string.Format("select * from vispro_1 where username = '{0}'", txtUsername.Text);
                    ds.Clear();
                    koneksi.Open();
                    perintah = new MySqlCommand(query, koneksi);
                    adapter = new MySqlDataAdapter(perintah);
